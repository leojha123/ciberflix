...
<head>
    <meta charset="UTF-8">
    <title>Registrar Película - CIBERFLIX</title>
...
<div class="container mx-auto p-6 max-w-2xl">
    <h2 class="text-3xl font-bold mb-6">Registrar Película</h2>
    ...
    <form action="RegistrarPeliculaServlet" method="post" class="space-y-4 bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        <div class="form-control">
            ...
            <input type="text" name="urlPortada" value="${urlPortada}" 
                   placeholder="https://ejemplo.com/imagen.jpg o data:image/jpeg;base64,..." 
                   class="input input-bordered w-full bg-gray-700 text-white" 
                   required>
            <label class="label">
            ...
            <select name="idCategoria" class="select select-bordered w-full bg-gray-700 text-white" required>
                ...
                <c:forEach var="cat" items="${categorias}">
                    <option value="${cat.idCategoria}" 
                            ${cat.idCategoria == idCategoria ? 'selected' : ''}>
                        ${cat.nombre}
                    </option>
                </c:forEach>
            </select>
